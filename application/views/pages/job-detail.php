				...
				<div class="row">
					<nav aria-label="breadcrumb">
						<ol class="breadcrumb">
							...
							<li class="breadcrumb-item"><a href="<?=base_url($this->session->userdata('site_lang_name'))?>/Workwithus" class="btn-breadcrumb"><?=lang("join-with-us")?></a></li>
						...
						<div class="space-blog">
							<div class="row">
								...
								<div class="col-lg-3 col-md-3 col-sm-3 col-12">
									...
									<div class="space-right-blog">
										<div class="inter-blog-right">
											<img src="<?=base_url()?>images/blogs/blog-1-s.png" class="img-width-100" >
											<h4>
												Title name
											</h4>
											<p>
